...
const std::string MEMBERS_FILE    = "/Users/kellyyu/Downloads/members.txt";
const std::string TRANSLATOR_FILE = "/Users/kellyyu/Downloads/translator.txt";
...
bool findMatches(const MemberDatabase& mdb, const AttributeTranslator& at)
{
    ...
    std::cout << "Found " << emails.size() << " matches." << std::endl;
