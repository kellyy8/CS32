...
//    std::map <std::string, ValueType*>* radT;
//};
//
//template <typename ValueType>
//inline
//RadixTree<ValueType>::RadixTree(){
//    radT = new std::map <std::string, ValueType*>;
//}
//
//template <typename ValueType>
//inline
...
//    //add new key, or update key's mapping with value
//    ValueType* vPtr = new ValueType(value);         //call copy constructor; dyn allo copy of value
//    (*radT)[key] = vPtr;             //store addresses to copies of the value
//}
//
//template <typename ValueType>
//inline
...
//    typename std::map<std::string, ValueType*>::iterator it;
//    it = radT->find(key);       //returns pointer to pair
//
//    if(it != radT->end())
